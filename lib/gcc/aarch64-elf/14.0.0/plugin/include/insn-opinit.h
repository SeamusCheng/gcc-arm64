...
extern rtx maybe_gen_aarch64_ld1 (machine_mode, rtx, rtx, rtx);
inline rtx
gen_aarch64_ld1 (machine_mode arg0, rtx x0, rtx x1, rtx x2)
{
  rtx res = maybe_gen_aarch64_ld1 (arg0, x0, x1, x2);
  gcc_assert (res);
  return res;
}
...
extern rtx maybe_gen_aarch64_st1 (machine_mode, rtx, rtx, rtx);
inline rtx
gen_aarch64_st1 (machine_mode arg0, rtx x0, rtx x1, rtx x2)
{
  rtx res = maybe_gen_aarch64_st1 (arg0, x0, x1, x2);
  gcc_assert (res);
  return res;
}
